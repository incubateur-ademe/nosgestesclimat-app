...
// @ts-nocheck 
/*
 * This file exports the `AnonOrganisationAdministrator` model and its related types.
 *
...
export type GetAnonOrganisationAdministratorAggregateType<T extends AnonOrganisationAdministratorAggregateArgs> = {
      [P in keyof T & keyof AggregateAnonOrganisationAdministrator]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateAnonOrganisationAdministrator[P]>
    : Prisma.GetScalarType<T[P], AggregateAnonOrganisationAdministrator[P]>
}
...
export type GetAnonOrganisationAdministratorGroupByPayload<T extends AnonOrganisationAdministratorGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<AnonOrganisationAdministratorGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof AnonOrganisationAdministratorGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], AnonOrganisationAdministratorGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], AnonOrganisationAdministratorGroupByOutputType[P]>
      }
    >
  >
...
export type AnonOrganisationAdministratorCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<AnonOrganisationAdministratorFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface AnonOrganisationAdministratorDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['AnonOrganisationAdministrator'], meta: { name: 'AnonOrganisationAdministrator' } }
  /**
  ...
  **/
  count<T extends AnonOrganisationAdministratorCountArgs>(
    args?: Prisma.Subset<T, AnonOrganisationAdministratorCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], AnonOrganisationAdministratorCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends AnonOrganisationAdministratorGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, AnonOrganisationAdministratorGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAnonOrganisationAdministratorGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
