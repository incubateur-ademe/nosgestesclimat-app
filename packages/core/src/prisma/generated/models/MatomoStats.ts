...
// @ts-nocheck 
/*
 * This file exports the `MatomoStats` model and its related types.
 *
...
export type GetMatomoStatsAggregateType<T extends MatomoStatsAggregateArgs> = {
      [P in keyof T & keyof AggregateMatomoStats]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateMatomoStats[P]>
    : Prisma.GetScalarType<T[P], AggregateMatomoStats[P]>
}
...
export type GetMatomoStatsGroupByPayload<T extends MatomoStatsGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<MatomoStatsGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof MatomoStatsGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], MatomoStatsGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], MatomoStatsGroupByOutputType[P]>
      }
    >
  >
...
export type MatomoStatsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<MatomoStatsFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface MatomoStatsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['MatomoStats'], meta: { name: 'MatomoStats' } }
  /**
   ...
   * })
  **/
  count<T extends MatomoStatsCountArgs>(
    args?: Prisma.Subset<T, MatomoStatsCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], MatomoStatsCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends MatomoStatsGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, MatomoStatsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMatomoStatsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
