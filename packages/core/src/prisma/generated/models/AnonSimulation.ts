...
// @ts-nocheck 
/*
 * This file exports the `AnonSimulation` model and its related types.
 *
...
export type GetAnonSimulationAggregateType<T extends AnonSimulationAggregateArgs> = {
      [P in keyof T & keyof AggregateAnonSimulation]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateAnonSimulation[P]>
    : Prisma.GetScalarType<T[P], AggregateAnonSimulation[P]>
}
...
export type GetAnonSimulationGroupByPayload<T extends AnonSimulationGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<AnonSimulationGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof AnonSimulationGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], AnonSimulationGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], AnonSimulationGroupByOutputType[P]>
      }
    >
  >
...
export type AnonSimulationCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<AnonSimulationFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface AnonSimulationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['AnonSimulation'], meta: { name: 'AnonSimulation' } }
  /**
   ...
   * })
  **/
  count<T extends AnonSimulationCountArgs>(
    args?: Prisma.Subset<T, AnonSimulationCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], AnonSimulationCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends AnonSimulationGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, AnonSimulationGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAnonSimulationGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
