...
// @ts-nocheck 
/*
 * This file exports the `AnonOrganisation` model and its related types.
 *
...
export type GetAnonOrganisationAggregateType<T extends AnonOrganisationAggregateArgs> = {
      [P in keyof T & keyof AggregateAnonOrganisation]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateAnonOrganisation[P]>
    : Prisma.GetScalarType<T[P], AggregateAnonOrganisation[P]>
}
...
export type GetAnonOrganisationGroupByPayload<T extends AnonOrganisationGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<AnonOrganisationGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof AnonOrganisationGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], AnonOrganisationGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], AnonOrganisationGroupByOutputType[P]>
      }
    >
  >
...
export type AnonOrganisationCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<AnonOrganisationFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface AnonOrganisationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['AnonOrganisation'], meta: { name: 'AnonOrganisation' } }
  /**
   ...
   * })
  **/
  count<T extends AnonOrganisationCountArgs>(
    args?: Prisma.Subset<T, AnonOrganisationCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], AnonOrganisationCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends AnonOrganisationGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, AnonOrganisationGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAnonOrganisationGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
