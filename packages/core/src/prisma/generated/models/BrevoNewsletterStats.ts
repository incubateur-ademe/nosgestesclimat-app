...
// @ts-nocheck 
/*
 * This file exports the `BrevoNewsletterStats` model and its related types.
 *
...
export type GetBrevoNewsletterStatsAggregateType<T extends BrevoNewsletterStatsAggregateArgs> = {
      [P in keyof T & keyof AggregateBrevoNewsletterStats]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateBrevoNewsletterStats[P]>
    : Prisma.GetScalarType<T[P], AggregateBrevoNewsletterStats[P]>
}
...
export type GetBrevoNewsletterStatsGroupByPayload<T extends BrevoNewsletterStatsGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<BrevoNewsletterStatsGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof BrevoNewsletterStatsGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], BrevoNewsletterStatsGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], BrevoNewsletterStatsGroupByOutputType[P]>
      }
    >
  >
...
export type BrevoNewsletterStatsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<BrevoNewsletterStatsFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface BrevoNewsletterStatsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['BrevoNewsletterStats'], meta: { name: 'BrevoNewsletterStats' } }
  /**
   ...
   * })
  **/
  count<T extends BrevoNewsletterStatsCountArgs>(
    args?: Prisma.Subset<T, BrevoNewsletterStatsCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], BrevoNewsletterStatsCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends BrevoNewsletterStatsGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, BrevoNewsletterStatsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBrevoNewsletterStatsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
