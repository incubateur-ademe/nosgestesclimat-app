...
// @ts-nocheck 
/*
 * This file exports the `QuizzAnswer` model and its related types.
 *
...
export type GetQuizzAnswerAggregateType<T extends QuizzAnswerAggregateArgs> = {
      [P in keyof T & keyof AggregateQuizzAnswer]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateQuizzAnswer[P]>
    : Prisma.GetScalarType<T[P], AggregateQuizzAnswer[P]>
}
...
export type GetQuizzAnswerGroupByPayload<T extends QuizzAnswerGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<QuizzAnswerGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof QuizzAnswerGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], QuizzAnswerGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], QuizzAnswerGroupByOutputType[P]>
      }
    >
  >
...
export type QuizzAnswerCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<QuizzAnswerFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface QuizzAnswerDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['QuizzAnswer'], meta: { name: 'QuizzAnswer' } }
  /**
   ...
   * })
  **/
  count<T extends QuizzAnswerCountArgs>(
    args?: Prisma.Subset<T, QuizzAnswerCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], QuizzAnswerCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends QuizzAnswerGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, QuizzAnswerGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetQuizzAnswerGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
