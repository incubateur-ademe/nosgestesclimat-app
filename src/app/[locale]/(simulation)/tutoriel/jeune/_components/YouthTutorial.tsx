  ...
  return (
    <div className="flex flex-col">
      ...
      <ul className="order-1 mb-12 grid grid-cols-2 gap-2 md:order-0 md:flex md:gap-8">
        <Card
          tag="li"
          className="shadow-primary-100 col-span-1 max-w-full flex-col justify-center rounded-2xl border-0 text-center text-sm shadow-lg drop-shadow-xs md:w-56 md:text-base">
