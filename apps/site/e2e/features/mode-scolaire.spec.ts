...
test.describe('A new user', () => {
  ...
  test('sees the youth tutorial when joining via the scolaire poll invite link', async ({
    scolairePoll,
    page,
  }) => {
  ...
  test.describe('When he completes the test via the scolaire poll invite link', () => {
